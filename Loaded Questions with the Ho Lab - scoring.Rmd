...
# Repo for this: 
# https://github.com/shirewoman2/LoadedQuestions/blob/master/Loaded-Questions-with-the-Ho-Lab---scoring.html

# To see the final html document, go to: 

# https://rawcdn.githack.com/shirewoman2/LoadedQuestions/master/Loaded-Questions-with-the-Ho-Lab---scoring.html
...
MyURL <- "https://docs.google.com/spreadsheets/d/1Wr9uZGywd5PegpErJ_XSt4FIpBu8oMcAlNnT870WbzM"

Questions <- range_read(MyURL, sheet = "Form Responses 1")
...
Scores <- Guesses %>% 
      ...
      left_join(Questions %>% 
                      mutate(CorrectAnswer = ifelse(CorrectAnswer == "maple bars", 
                                                    "maple bars", CorrectAnswer)) ) %>% 
